...
- timestamp: 2026-05-25
  observation: Further inspection found `validation_mae` rebuilt the GLS/GSP validation matrix on each trial, causing posterior inverse cache entries to grow linearly by matrix object identity.
