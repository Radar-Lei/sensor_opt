...
Table~\ref{tab:trace-biopt-comparison-class-contract} summarizes the
comparison class used throughout the paper: 21 pre-registered baselines
spanning 11 method families, evaluated by row-wise strongest-baseline
dominance on held-out reconstruction error with Holm-corrected paired tests.

\input{tables/table_trace_biopt_comparison_class_contract}
...
\input{tables/table_trace_biopt_novelty_identity}
