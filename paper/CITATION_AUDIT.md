...
- All 33 cited entries have web-ledger rows and citation contexts support the manuscript claims at the required level.
- Coverage residuals: missing_bib=[], uncited_bib=[], missing_web=[], extra_web=[].
