...
- Fresh machine audit checked 1650 TRACE-BiOpt paper-visible claims against the current-best hybrid CSV/JSON evidence chain.
- Dominance-table values, paired-win counts, p-values, row counts, ten-split scope, and weakest-row caveat are verified.
