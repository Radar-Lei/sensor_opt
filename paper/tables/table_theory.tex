...
finite candidate validation selection & For a finite candidate class and independent validation split, empirical validation risk uniformly concentrates around deployment risk at a rate controlled by $\sqrt{\log|\calC|/n_{\mathrm{v}}}$ under bounded or sub-exponential loss assumptions. & does not convert validation ranking into a held-out test guarantee or universal deployment guarantee \\
