...
0.2    best_random_by_trace          gls_map              3.278961       NaN   5.775069       NaN  0.072158       NaN
       ...
       multistart_swap_by_validation gls_map              3.106638       NaN   5.436331       NaN  0.072204       NaN
                                     gsp                  3.620781       NaN   6.267314       NaN  0.082583       NaN
                                     historical_tod_mean  4.010993       NaN   6.893635       NaN  0.085388       NaN
                                     neighbor_average     6.518444       NaN  10.376984       NaN  0.166568       NaN
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.361188      0.353916 642
    gsp   condition_number     0.363101      0.345857 642
    gsp information_logdet    -0.366199     -0.384511 642
gls_map    posterior_trace     0.853409      0.845321 642
gls_map   condition_number     0.810515      0.843258 642
gls_map information_logdet    -0.824277     -0.806743 642
```
