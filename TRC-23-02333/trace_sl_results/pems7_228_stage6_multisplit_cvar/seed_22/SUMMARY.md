...
0.2    best_random_by_trace          gls_map               3.509130       NaN   6.164045       NaN  0.095843       NaN
       ...
       multistart_swap_by_validation gls_map               3.228806       NaN   5.446111       NaN  0.082466       NaN
                                     gsp                   3.677065       NaN   6.344650       NaN  0.097267       NaN
                                     historical_tod_mean   3.573242       NaN   6.349306       NaN  0.096206       NaN
                                     neighbor_average      7.310974       NaN  11.243152       NaN  0.206430       NaN
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.203527      0.256914 642
    gsp   condition_number     0.204422      0.196260 642
    gsp information_logdet    -0.224305     -0.262403 642
gls_map    posterior_trace     0.843389      0.847452 642
gls_map   condition_number     0.816389      0.844500 642
gls_map information_logdet    -0.801321     -0.799807 642
```
