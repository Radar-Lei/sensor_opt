...
0.3    best_random_by_trace          gls_map               3.376237       NaN   5.861017       NaN  0.085798       NaN
       ...
       rcss_selected                 gls_map               3.092584       NaN   5.325295       NaN  0.075762       NaN
                                     gsp                   3.838338       NaN   6.647367       NaN  0.095403       NaN
                                     historical_tod_mean   4.061528       NaN   7.257565       NaN  0.101662       NaN
                                     neighbor_average      6.691493       NaN  10.195806       NaN  0.161916       NaN
       ...
       validation_swap_selected      gls_map               3.028041       NaN   5.171517       NaN  0.072539       NaN
                                     gsp                   3.732972       NaN   6.408305       NaN  0.089707       NaN
                                     historical_tod_mean   3.943175       NaN   7.043309       NaN  0.096679       NaN
                                     neighbor_average      6.899076       NaN  10.476141       NaN  0.161699       NaN
```
...
```
 budget              layout_type  method      mae     rmse
    ...
    0.3 validation_swap_selected gls_map 3.028041 5.171517
```
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.192354      0.198766 651
    gsp   condition_number     0.195528      0.200177 651
    gsp information_logdet    -0.198520     -0.234758 651
gls_map    posterior_trace     0.872573      0.855879 651
gls_map   condition_number     0.835337      0.863910 651
gls_map information_logdet    -0.837977     -0.823370 651
```
