...
```
 budget                   layout_type  method      mae     rmse
    ...
    0.3                        random gls_map 3.028364 5.175912
```
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.122635      0.153298 648
    gsp   condition_number     0.125006      0.137754 648
    gsp information_logdet    -0.136944     -0.172371 648
gls_map    posterior_trace     0.862404      0.854545 648
gls_map   condition_number     0.833101      0.853158 648
gls_map information_logdet    -0.819195     -0.808216 648
```
