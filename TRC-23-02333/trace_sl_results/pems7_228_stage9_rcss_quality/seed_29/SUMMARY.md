...
```
 budget                 layout_type  method      mae     rmse
    ...
    0.2               rcss_selected gls_map 3.238403 5.516886
    0.3               rcss_selected gls_map 3.053056 5.328909
```
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.188594      0.194782 648
    gsp   condition_number     0.191925      0.198344 648
    gsp information_logdet    -0.194997     -0.230906 648
gls_map    posterior_trace     0.876083      0.859079 648
gls_map   condition_number     0.839448      0.868665 648
gls_map information_logdet    -0.841859     -0.825383 648
```
