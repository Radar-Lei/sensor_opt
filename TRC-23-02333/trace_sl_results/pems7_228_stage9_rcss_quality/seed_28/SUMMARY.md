...
```
 budget              layout_type  method      mae     rmse
    ...
    0.3                   random gls_map 2.867789 4.986371
```
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace     0.226311      0.246517 648
    gsp   condition_number     0.229323      0.243825 648
    gsp information_logdet    -0.229220     -0.259995 648
gls_map    posterior_trace     0.870448      0.853295 648
gls_map   condition_number     0.843622      0.865711 648
gls_map information_logdet    -0.836987     -0.817434 648
```
