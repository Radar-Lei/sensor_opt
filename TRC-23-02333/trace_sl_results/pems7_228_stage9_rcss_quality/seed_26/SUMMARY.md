...
```
 budget           layout_type  method      mae     rmse
    ...
    0.2         rcss_selected gls_map 3.508528 5.946002
    0.3                random gls_map 3.325782 5.538727
```
...
```
 method        certificate  pearson_mae  spearman_mae   n
    gsp    posterior_trace    -0.087907     -0.106241 648
    gsp   condition_number    -0.085007     -0.101852 648
    gsp information_logdet     0.078872      0.064961 648
gls_map    posterior_trace     0.841921      0.844596 648
gls_map   condition_number     0.834192      0.846710 648
gls_map information_logdet    -0.788396     -0.798508 648
```
